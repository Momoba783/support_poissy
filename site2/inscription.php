...
if($_POST){
	...
	if(!$verif_caractere || (strlen($_POST['pseudo']) < 1 ||strlen($_POST['pseudo']) > 20)){
		...
		if($membre->rowCount() > 0){
			...
			Ce pseudo est victime de son succès !</div>";
		}else{
			...
			//Créer un contact
			executeRequete("INSERT INTO membre (pseudo, mdp, nom, prenom, email, civilite, ville, cp, adresse, accepte, photo) VALUES ('$_POST[pseudo]',MD5('$_POST[mdp]'),'$_POST[nom]','$_POST[prenom]','$_POST[email]','$_POST[civilite]','$_POST[ville]','$_POST[cp]','$_POST[adresse]','$_POST[accepte]','$_POST[photo]')");
