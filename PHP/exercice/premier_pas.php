...
//ne pas oublier d'ouvrir mes balises php
    ...
    $var2 = 0;
    if(empty($var2)) {echo "0, vide ou non definie <br>";};
...
echo  "<br>" . iconv_strlen($phrase);//renvoie la taille d'une chaîne de caractères(nb de caracteres faisant partie de la chaîne d'octets. strlen recupere uniquement la taille, pas les octets)
...
//exercice: creer une fonction meteo qui permet d'afficher la saison et la temperature : "nous sommes en hiver et il fait 1 degre". Il faut gerer les cas si degre est au pluriel ou au singulier
...
echo "<p>cf main, header, navigatio  n etc</p>";
